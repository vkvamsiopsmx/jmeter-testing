...
$(document).ready(function() {
    ...
    var data = {"OkPercent": 36.95652173913044, "KoPercent": 63.04347826086956};
    var dataset = [
        {
            "label" : "KO",
            "data" : data.KoPercent,
    ...
    // Create error table
    createTable($("#errorsTable"), {"supportsControllersDiscrimination": false, "titles": ["Type of error", "Number of errors", "% in errors", "% in all samples"], "items": [{"data": ["400\/Bad Request", 53, 91.37931034482759, 57.608695652173914], "isController": false}, {"data": ["500", 5, 8.620689655172415, 5.434782608695652], "isController": false}]}, function(index, item){
        switch(index){
            case 2:
            case 3:
                item = item.toFixed(2) + '%';
