...
$(document).ready(function() {
    ...
    var data = {"OkPercent": 39.77272727272727, "KoPercent": 60.22727272727273};
    var dataset = [
        {
            "label" : "KO",
            "data" : data.KoPercent,
    ...
    // Create error table
    createTable($("#errorsTable"), {"supportsControllersDiscrimination": false, "titles": ["Type of error", "Number of errors", "% in errors", "% in all samples"], "items": [{"data": ["400\/Bad Request", 53, 100.0, 60.22727272727273], "isController": false}]}, function(index, item){
        switch(index){
            case 2:
            case 3:
                item = item.toFixed(2) + '%';
